...
class Occurence:
    ...
    def occurence_stats(self):
        """This function is used for occurence stats"""
        with open("filter_list_file.txt", "r") as my_file:
            ...
            for i in alphabets:
                ...
                self.dict_lst[i] = [round(count_list[0]/x, 3),round(count_list[1]/x, 3),round(count_list[2]/x, 3),round(count_list[3]/x, 3),round(count_list[4]/x, 3)]            
