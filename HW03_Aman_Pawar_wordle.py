...
class Main:
    ...
    def main(self):
        ...
        while(True):
            ...
            self.gamesPlayed+=1
            try:
                self.output_stats(self.gamesPlayed, self.gamesWon, self.gameStats)
            except:
                print("Fatal error: annot output statistics")
            try:
                logger.log_writer(myWord, words, self.gamesPlayed, self.gamesWon, self.gameStats)
            except:
